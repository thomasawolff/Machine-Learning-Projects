...
class dataSetupRun(object):
    ...
    def __init__(self):
        ...
        self.epochs = 25 # the number of iterations per running of code
...
##    def validationDataPredictions(self):
##        self.modelSetupRun()
##        print('\n# Evaluate ####################################################')
##        resultMet = self.model.evaluate(self.validation_data_gen)
